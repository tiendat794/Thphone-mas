   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-9 order-1 order-lg-2">
            ...
            <div class="shop-top-bar mt-30">
               ...
               <div class="product-select-box">
                  <div class="product-short">
                     <p>Sort By:</p>
                     <select id="choose" class="nice-select">
                        <option id="az" value="sales">Name (A - Z)</option>
                        <option id="az" value="sales2">Name (Z - A)</option>
                     </select>
                  </div>
               </div>
            ...
            <div id="sanpham" class="shop-products-wrapper">
...
<script>
                 $(document).ready(function () {
                  $(".nice-select").click(function () {
                        $.ajax({
                           type: "POST",
                           url: "view/layout/showZa.php",
                           data: {},
                           dataType: "json",
                           success: function (response) {
                              var kq = "";
                              response.forEach(data1 => {
                                 kq += `<div class="tab-content">
                  <div id="grid-view" class="tab-pane fade active show" role="tabpanel">
                     <div class="product-area shop-product-area">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6 mt-40">
                               ...
                               <div class="single-product-wrap">
                                  <div class="product-image">
                                     <a href="?act=single-product&idsp=`+data1['idsp']+`">
                                        <img src="upload/sanpham/`+ data1['hinhanh']+`" alt="Li's Product Image">
                                     </a>
                                     <span class="sticker">Mới</span>
                                  </div>
                                  <div class="product_desc">
                                     <div class="product_desc_info">
                                        <div class="product-review">
                                           <h5 class="manufacturer">
                                              <a href="?act=single-product">`+data1['tendm']+`</a>
                                           </h5>
                                           <div class="rating-box">
                                              <ul class="rating">
                                                 <li><i class="fa fa-star-o"></i></li>
                                        ...
                                        <h4><a class="product_name" href="?act=single-product">`+ data1['tensp']+`</a></h4>
                                        <div class="price-box">
                                           <span class="new-price">`+ Number(data1['gia']) + "đ" +`</span>
                                        </div>
                                     </div>
                                     <div class="add-actions">
                                        <ul class="add-actions-link">
                                           <li class="add-cart active"><a href="?act=cart&action=addcart&idsp=`+ data1['idsp']+` ">Thêm giỏ hàng</a></li>
                                           <li><a href="#" title="quick view" class="quick-view-btn" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-eye"></i></a></li>
                                           <li><a class="links-details" href="?act=wishlist"><i class="fa fa-heart-o"></i></a></li>
                                        </ul>
                                     </div>
                        ...
                        <div class="col">
                            <div class="row product-layout-list">
                               ...
                               <div class="col-lg-4">
                                  <div class="shop-add-action mb-xs-30">
                                     <ul class="add-actions-link">
                                        <li class="add-cart"><a href="?act=cart&action=addcart&idsp=`+ data1['idsp']+` ">Thêm giỏ hàng</a></li>
                                        <li class="wishlist"><a href="?act=wishlist"><i class="fa fa-heart-o"></i>Add to wishlist</a></li>
                                        <li><a class="quick-view" data-toggle="modal" data-target="#exampleModalCenter" href="#"><i class="fa fa-eye"></i>Quick view</a></li>
                                     </ul>
                                  </div>
